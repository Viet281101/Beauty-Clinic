...
function Hero() {
	return (
		...
		<div className="hero-content font-semibold text-left w-1/2">
			<h1 className="leading-[5rem] tracking-[0.012rem]">Clinic & beauty<br/>consultant</h1>
			<p className="tracking-widest leading-[1.8rem]">It is a long established fact that a reader will be<br/>by the readable content of a page.</p>
